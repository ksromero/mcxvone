...
Route::get('customer-application','FrontendController@customerApplication');
Route::get('credit-investigation-report','FrontendController@creditInvestigationReport');
...
Route::get('customer-application', 'CustomerApplicationController@getCustomerInfo');
...
Route::group([
    ...
    Route::post('api/customer-application', 'CustomerApplicationController@store');
    // Dashboard
    //----------------------------------
    Route::get('/', [
    ...
    Route::get('customer-list-module','CustomerListModuleController@index');
    Route::get('customer-application','CustomerApplicationController@index');
    Route::get('computation-system','ComputationSystemController@index');
    Route::get('inventory-list-module','InventoryListModuleController@index');
    Route::get('credit-investigation-report','CreditInvestigationReportController@index');
